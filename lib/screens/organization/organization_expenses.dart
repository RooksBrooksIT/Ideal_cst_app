    ...
    return showDialog<void>(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          title: Text('Confirm Submission', style: TextStyle(color: mainColor, fontWeight: FontWeight.bold)),
          content: SingleChildScrollView(
            child: ListBody(
              children: <Widget>[
                ...
                const Text('Are you sure you want to submit this expense entry?'),
              ],
            ),
          ),
          actions: <Widget>[
        ...
        builder: (context) => AlertDialog(
          ...
          content: Column(
            ...
            children: const [
              ...
              SizedBox(height: 16),
              Text(
                'Your expense data was submitted successfully!',
