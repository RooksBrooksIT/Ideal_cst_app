                        ...
                        : SingleChildScrollView(
                            ...
                            child: Column(
                              ...
                              children: [
                                      ...
                                      Row(
                                        children: [
                                          Container(
                                            ...
                                            child: Icon(Icons.business, size: 20, color: primaryColor),
                                          ),
                                ...
                                _buildInfoCard(
                                  children: [
                                    _buildInfoItem('Site ID', projectData?['siteid'] ?? projectData?['siteId'] ?? '-', Icons.tag),
                                    _buildInfoItem('Site Location', projectData?['siteLocation'] ?? '-', Icons.location_on),
                                    _buildInfoItem('Planned Start Date', _formatDate(projectData?['plannedStartDate']), Icons.calendar_today),
                                    _buildInfoItem('Actual Start Date', _formatDate(projectData?['actualStateDate']), Icons.calendar_today),
                                    _buildInfoItem('Current Date', _formatDate(DateTime.now()), Icons.calendar_today),
                                    _buildInfoItem('Duration', '${_calculateDurationInDays(projectData)} days', Icons.timelapse),
                                  ],
                                ),
                                const SizedBox(height: 24),
                                ...
                                _buildInfoCard(
                                  children: [
                                    _buildFinancialItem('Project Budget', projectData?['projectBudget'], Icons.account_balance_wallet, primaryColor),
                                    _buildFinancialItem('Amount Received', projectData?['amountPaid'], Icons.arrow_downward, successColor),
                                    _buildFinancialItem('Amount Spent', projectData?['amountSpent'], Icons.arrow_upward, dangerColor),
                                    _buildFinancialItem('Balance Amount', projectData?['amountBalance'], Icons.account_balance, accentColor),
                                  ],
                                ),
                                const SizedBox(height: 24),
                                if (projectData?['projectBudget'] != null && projectData?['amountSpent'] != null)
